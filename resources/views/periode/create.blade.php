<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <div class="text-xl font-bold tracking-tight text-brand-navy dark:text-white">Tambah Periode</div>
        </div>
    </x-slot>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('periode.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <x-text-input id="nama" name="nama" type="text" class="mt-1 block w-full" :value="old('nama')" placeholder="Contoh: Juli 2026" required />
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <x-text-input id="tanggal_mulai" name="tanggal_mulai" type="date" class="mt-1 block w-full" :value="old('tanggal_mulai', now()->toDateString())" required />
                ...
                <div class="flex items-center gap-2">
                    <label class="inline-flex items-center gap-2">
                        <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-brand-navy focus:ring-brand-navy">
